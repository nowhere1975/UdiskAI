...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkWorkingDirectory: '工作空间',
    coworkWorkingDirectoryPlaceholder: '输入工作空间路径',
    ...
    scheduledTasksFormValidationWorkingDirectoryRequired: '请选择任务工作空间',
    ...
    scheduledTasksFormWorkingDirectory: '工作空间',
    scheduledTasksFormWorkingDirectoryPlaceholder: '输入工作空间路径',
    ...
    scheduledTasksWorkingDirectory: '工作空间',
    ...
    kbNoZhipuKey: '知识库需要配置向量 API Key 才能索引文件（设置 → 模型 → 知识库向量服务）',
    kbEmbedSettings: '知识库向量服务',
    kbEmbedProvider: '向量模型',
    kbEmbedApiKey: '向量 API Key',
    kbVisionProvider: '图片识别（可选）',
    kbVisionApiKey: '视觉 API Key',
    kbProviderSiliconflow: '硅基流动 · BGE-M3（免费）',
    kbProviderZhipu: '智谱 · embedding-3',
    kbProviderQwen: '通义千问 · text-embedding-v3',
    kbVisionNone: '不启用',
    kbVisionZhipu: '智谱 GLM-4V',
    kbVisionQwen: '通义千问-VL',
    kbRegisterLink: '注册获取免费 Key →',
    kbRebuildHint: '更改向量提供商后需点击"重建索引"生效',
    kbIndexStatus: '索引状态',
    ...
    kbStatDocs: '文档',
    kbStatChunks: '分块',
    kbStatSuccessFail: '成功 / 失败',
    kbScope: '知识范围',
    kbScopeEmpty: '点击"生成"让 AI 分析知识库内容',
    kbScopeGenerate: '生成',
    kbScopeRefresh: '刷新',
    kbScopeGenerating: '分析中…',
    kbShowAll: '查看全部 {n} 个文件',
    kbCollapse: '收起',
    kbChunkCount: '{n} 块',
    kbStatusIdle: '已同步',
  ...
  en: {
    ...
    coworkWorkingDirectory: 'Workspace',
    coworkWorkingDirectoryPlaceholder: 'Enter workspace path',
    ...
    scheduledTasksFormValidationWorkingDirectoryRequired: 'Task workspace is required',
    ...
    scheduledTasksFormWorkingDirectory: 'Workspace',
    scheduledTasksFormWorkingDirectoryPlaceholder: 'Enter workspace path',
    ...
    scheduledTasksWorkingDirectory: 'Workspace',
    ...
    kbNoZhipuKey: 'Knowledge base requires an embedding API key to index files (Settings → Model → KB Embedding)',
    kbEmbedSettings: 'KB Embedding Service',
    kbEmbedProvider: 'Embedding Model',
    kbEmbedApiKey: 'Embedding API Key',
    kbVisionProvider: 'Image Recognition (Optional)',
    kbVisionApiKey: 'Vision API Key',
    kbProviderSiliconflow: 'SiliconFlow · BGE-M3 (Free)',
    kbProviderZhipu: 'Zhipu · embedding-3',
    kbProviderQwen: 'Qwen · text-embedding-v3',
    kbVisionNone: 'Disabled',
    kbVisionZhipu: 'Zhipu GLM-4V',
    kbVisionQwen: 'Qwen-VL',
    kbRegisterLink: 'Register for free Key →',
    kbRebuildHint: 'After changing the embedding provider, click "Rebuild Index" to apply',
    ...
    kbStatDocs: 'Documents',
    kbStatChunks: 'Chunks',
    kbStatSuccessFail: 'OK / Failed',
    kbScope: 'Knowledge Scope',
    kbScopeEmpty: 'Click "Generate" to let AI analyze the knowledge base',
    kbScopeGenerate: 'Generate',
    kbScopeRefresh: 'Refresh',
    kbScopeGenerating: 'Analyzing…',
    kbShowAll: 'Show all {n} files',
    kbCollapse: 'Collapse',
