...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    contextWindow: '上下文窗口',
    contextWindowHint: '模型一次可处理的最大 token 数量。窗口越大，可容纳的对话历史和文档越多。',
    imageInput: '图像',
  ...
  en: {
    ...
    contextWindowHint: 'The maximum number of tokens the model can process at once. Larger windows can hold more chat history and documents.',
    imageInput: 'Image',
    ...
    qianfanCodingPlanHint: 'When enabled, uses the Baidu Qianfan Coding Plan dedicated API endpoint',
    qianfanCodingPlanEndpointHint: 'When using Coding Plan, the system will automatically switch to the dedicated Coding endpoint',
    import: 'Import',
    export: 'Export',
