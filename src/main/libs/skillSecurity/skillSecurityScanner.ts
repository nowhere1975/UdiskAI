...
const JSXRAY_WARNING_MAP: Record<string, JsxrayWarningMap> = {
  ...
  'serialize-environment': { dimension: 'file_access', severity: 'danger' },
  'shady-link': { dimension: 'network', severity: 'warning' },
  'unsafe-import': { dimension: 'process', severity: 'warning' },
  'weak-crypto': { dimension: 'network', severity: 'warning' },
  'suspicious-file': { dimension: 'process', severity: 'critical' },
  'insecure-random': { dimension: 'network', severity: 'warning' },
